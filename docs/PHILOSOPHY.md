...
Today that built-in baseline covers JavaScript, TypeScript, TSX, Python, Go, Haskell, Java, Kotlin, Lua, PHP, Ruby, Rust, Swift, C#, C, and C++.
...
- Python, Go, Haskell, Java, Kotlin, Lua, PHP, Ruby, Rust, Swift, C#, C, and C++: built-in Tree-sitter analysis finds baseline imports, symbols, and low-noise structural relationships, plugins can add richer project-aware semantics
