...
import { resolveRustUsePath } from '../../../src/treeSitter/runtime/analyzeRust/usePath';
import { findExistingFile } from '../../../src/treeSitter/runtime/analyze/existingFile';
import { getRustCrateRoot } from '../../../src/treeSitter/runtime/projectRoots';
...
describe('treeSitter/runtime/analyzeRust/usePath', () => {
  beforeEach(() => {
    vi.clearAllMocks();
