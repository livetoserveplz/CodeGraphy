...
vi.mock('../../../../src/treeSitter/runtime/projectRoots/go/module', () => goModuleMock);
vi.mock('../../../../src/treeSitter/runtime/projectRoots/search', () => sharedMock);

import { resolveGoPackagePath } from '../../../../src/treeSitter/runtime/projectRoots/go/packagePath';
