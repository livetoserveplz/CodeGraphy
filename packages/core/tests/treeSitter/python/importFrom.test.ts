...
import { handlePythonImportFromStatement } from '../../../src/treeSitter/runtime/analyzePython/importFrom';
import {
  getIdentifierText,
  getLastPathSegment,
  joinModuleSpecifier,
} from '../../../src/treeSitter/runtime/analyze/nodes';
import {
  getPythonImportFromImportedNodes,
  getPythonImportFromModuleNode,
  getPythonImportedName,
} from '../../../src/treeSitter/runtime/analyzePython/importFromNodes';
import { resolvePythonImportFromPath } from '../../../src/treeSitter/runtime/analyzePython/importFromPath';
...
vi.mock('../../../src/treeSitter/runtime/analyzePython/importFromNodes', () => ({
  getPythonImportFromImportedNodes: vi.fn(),
  getPythonImportFromModuleNode: vi.fn(),
  getPythonImportedName: vi.fn(),
}));

vi.mock('../../../src/treeSitter/runtime/analyzePython/importFromPath', () => ({
  resolvePythonImportFromPath: vi.fn(),
}));

vi.mock('../../../src/treeSitter/runtime/analyzePython/paths', () => ({
