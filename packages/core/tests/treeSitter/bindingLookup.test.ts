...
import { getIdentifierText } from '../../src/treeSitter/runtime/analyze/text';

vi.mock('../../src/treeSitter/runtime/analyze/text', () => ({
...
describe('pipeline/plugins/treesitter/runtime/analyzeImportBinding/lookup', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
