...
import { handleGoImportDeclaration } from '../../../src/treeSitter/runtime/analyzeGo/imports';
import { resolveGoPackagePath } from '../../../src/treeSitter/runtime/projectRoots';
...
describe('pipeline/plugins/treesitter/runtime/analyzeGo/imports', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
