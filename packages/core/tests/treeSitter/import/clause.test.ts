...
import { applyImportClauseBinding } from '../../../src/treeSitter/runtime/analyzeImportBinding/clause';
import { addCollectedImportBinding } from '../../../src/treeSitter/runtime/analyzeImportBinding/collected';
import { addNamedImportBindings } from '../../../src/treeSitter/runtime/analyzeImportBinding/namedBindings';

vi.mock('../../../src/treeSitter/runtime/analyzeImportBinding/collected', () => ({
  addCollectedImportBinding: vi.fn(),
}));

vi.mock('../../../src/treeSitter/runtime/analyzeImportBinding/namedBindings', () => ({
