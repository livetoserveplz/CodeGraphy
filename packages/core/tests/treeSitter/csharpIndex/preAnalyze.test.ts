...
import { preAnalyzeCSharpTreeSitterFiles } from '../../../src/treeSitter/runtime/csharpIndex/preAnalyze';
import { createTreeSitterRuntime } from '../../../src/treeSitter/runtime/languages';
import { indexCSharpTree } from '../../../src/treeSitter/runtime/csharpIndex/tree';
import {
  clearCSharpWorkspaceIndex,
  createEmptyCSharpIndex,
  setCSharpWorkspaceIndex,
} from '../../../src/treeSitter/runtime/csharpIndex/store';

vi.mock('../../../src/treeSitter/runtime/languages', () => ({
  createTreeSitterRuntime: vi.fn(),
}));

vi.mock('../../../src/treeSitter/runtime/csharpIndex/tree', () => ({
  indexCSharpTree: vi.fn(),
}));

vi.mock('../../../src/treeSitter/runtime/csharpIndex/store', () => ({
