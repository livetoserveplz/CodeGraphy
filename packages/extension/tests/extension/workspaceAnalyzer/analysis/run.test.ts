...
import * as analyzeModule from '../../../../src/extension/workspaceAnalyzer/analysis/analyze';
import { runWorkspaceAnalyzerAnalysis } from '../../../../src/extension/workspaceAnalyzer/analysis/run';

describe('workspaceAnalyzer/analysis/run', () => {
