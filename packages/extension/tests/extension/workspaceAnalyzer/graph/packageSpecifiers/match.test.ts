...
import { isExternalPackageSpecifier } from '../../../../../src/extension/workspaceAnalyzer/graph/packageSpecifiers/match';

describe('workspaceAnalyzer/graph/packageSpecifiers/match', () => {
