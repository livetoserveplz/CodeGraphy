...
vi.mock('../../../src/extension/graphView/providerAnalysisMethodDelegates', async importOriginal => {
  const actual = await importOriginal<
    typeof import('../../../src/extension/graphView/providerAnalysisMethodDelegates')
  >();
