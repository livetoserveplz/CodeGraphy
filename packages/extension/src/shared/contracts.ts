 ...
 * - `NODE_SELECTED` - Temporary preview-open request from single-click node selection
 * - `NODE_DOUBLE_CLICKED` - Permanent open request from node activation (double-click or Enter)
