/**
 * Polygon shape drawing functions for 2D canvas.
 *
 * Each function calls `beginPath()` and defines the geometry. The caller is
 * responsible for calling `fill()` and/or `stroke()` afterwards.
 */
