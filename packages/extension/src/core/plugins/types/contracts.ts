...
export interface IPlugin {
  ...
  fileColors?: Record<string, string | {
    color: string;
    shape2D?: import('../../../shared/settings/modes').NodeShape2D;
    shape3D?: import('../../../shared/settings/modes').NodeShape3D;
  ...
  onWorkspaceReady?(graph: import('../../../shared/graph/types').IGraphData): void;
  ...
  onPostAnalyze?(graph: import('../../../shared/graph/types').IGraphData): void;

  /** Called when the graph is rebuilt from cache without re-analysis. */
  onGraphRebuild?(graph: import('../../../shared/graph/types').IGraphData): void;
