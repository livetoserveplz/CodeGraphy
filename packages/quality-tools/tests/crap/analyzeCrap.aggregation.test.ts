...
import type { FunctionInfo } from '../../src/crap/extractFunctions';
...
vi.mock('../../src/crap/fileSelection', () => ({
...
describe('analyzeCrap aggregation', () => {
  ...
  it('filters missing files, excludes exact-threshold results, rounds CRAP, and sorts descending', async () => {
    ...
    const { analyzeCrap } = await import('../../src/crap/analyzeCrap');
